...
class Pengadaan extends CI_Controller {
	...
	public function pengadaan()
	{
		...
		if (isset($_POST['filter'])) {
			...
			$data['item'] = $this->mp->getPengadaanFilterAset($id_lokasi, $tahun_pengadaan);
	...
	public function print_filter_data($id_lokasi, $tahun_pengadaan)
	{
		...
		$data = array(
			'title' => 'Laporan Pengadaan Aset',
			'aset' => $this->mp->filterSetujuiPengadaan($id_lokasi, $tahun_pengadaan)
		);
