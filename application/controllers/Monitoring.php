...
class Monitoring extends CI_Controller {
	...
	public function index()
	{
		...
		if (isset($_POST['filter'])) {
			...
			$data['mt'] = $this->mm->getFilterMonitoring($id_lokasi,$tahun_perolehan);

			$data['id_lokasi'] = $id_lokasi;
			$data['tahun_perolehan'] = $tahun_perolehan;
		} else {
			$data['mt'] = $this->mm->getMonitoring();
		}
	
		$this->load->view('layouts/header',$data);
		$this->load->view('monitoring/v_monitoring');
	...
	public function print_all_data()
	{
		$data = array(
			...
			'mnt' => $this->mm->getMonitoring(),
		);
	
		$this->load->view('report/header',$data);
		$this->load->view('monitoring/print');
	...
	public function print_filter_data($id_lokasi, $tahun_perolehan)
	{
		...
		$data = array(
			'title' => 'Laporan Monitoring Aset',
			'mnt' => $this->mm->getFilterMonitoring($id_lokasi,$tahun_perolehan)
		);
