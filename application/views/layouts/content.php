    ...
    <section class="content">
      <div class="container-fluid">
        <div class="alert alert-info">
            ...
            Selamat Datang di Website Sistem Informasi Manajemen Aset Yayasan An-Nur Cabangbungin
          </div>
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  <h3>
                    <?php if ($wujud->jumlah) {
                      echo number_format($wujud->jumlah + $hapuskan->jml,0,',','.');
                    } else {
                      echo "0";
                    } ?>
                  </h3>
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3>
                    <?php if ($wujud->jumlah) {
                      echo number_format($wujud->jumlah,0,',','.');
                    } else {
                      echo "0";
                    } ?>
                  </h3>
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <h3>
                    <?php if ($hapuskan->jml) {
                      echo number_format($hapuskan->jml,0,',','.'); 
                    } else {
                      echo "0";
                    } ?>
                  </h3>
