...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?=base_url()?>src/img/logo/<?=$app['picture'];?>" class="brand-image"
           style="opacity: .8">
      <span class="brand-text font-weight-light"><?=$app['name_app'];?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!-- <li class="nav-item has-treeview">
          <a href="<?=base_url('loan')?>" class="nav-link <?=isset($active_pinjam)?$active_pinjam:'' ?>">
