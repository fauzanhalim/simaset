            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <table class="table table-bordered table-sm">
                  ...
                  <?php } ?>
                     <tr>
                      <td colspan="6"><b>Total Penyusutan :</b> 
                          <?php
                            $tahun_skrg_x = date("Y");
                            $rentang_x = ($tahun_skrg_x-$item['tahun_perolehan'])+1;
                            if($rentang_x > $item['umur_ekonomis']){
                              $rentang_x = $item['umur_ekonomis'];
                            }
                            
                            $tarif_penyusutan_x = (100/100)/$item['umur_ekonomis'];
                            $nilai_sisa_x = $tarif_penyusutan_x*$item['harga'];
                            $penyusutan_x = ($item['harga']-$nilai_sisa_x)/$item['umur_ekonomis'];
                            $akumulasi_penyusutan_x = $penyusutan_x*$rentang_x; 
                            $nilai_aset_x = $item['harga']-$akumulasi_penyusutan_x;

                            echo rupiah($akumulasi_penyusutan_x);
                          ?>
                      </td>
                     </tr> 
                </tbody>
