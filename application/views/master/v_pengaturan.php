          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#setup" data-toggle="tab">Setup Aplikasi</a></li>
                <?php } ?>
              </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
            ...
            <?php endif ?>
              <div class="tab-content">
                ...
                <div class="tab-pane" id="setup">
                  <form class="form-horizontal" action="<?=base_url('users/change_identity')?>" autocomplete="off" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" value="<?=$item['name_app'];?>" name="name_app" placeholder="Masukan Nama Aplikasi.." required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="name_institute" class="col-sm-2 col-form-label">Nama Instansi</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" value="<?=$item['name_institute'];?>" name="name_institute" placeholder="Nama Instansi.." required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="address" class="col-sm-2 col-form-label">Alamat</label>
                        <div class="col-sm-6">
                          <textarea name="address" class="form-control" required placeholder="Masukan Alamat.."><?=$item['address'];?></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="city" class="col-sm-2 col-form-label">Kota</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" value="<?=$item['city'];?>" name="city" placeholder="Nama Kota.." required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="picture" class="col-sm-2 col-form-label">Logo Instansi</label>
                        <div class="col-sm-6">
                          <input type="file" class="form-control" name="picture" id="post-image" accept="image/*">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="picture" class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-6">
                          <img id="preview-img" src="<?=base_url()?>src/img/logo/<?=$item['picture'];?>" class="img-fluid rounded mb-2" alt="Preview Image" style="height: 165px;">
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
