...
class ModelPengadaan extends CI_Model {
	...
	public function getPengadaanFilterAset($id_lokasi, $tahun_pengadaan)
	{
		$this->db->select('*');
		$this->db->from('pengadaan a');
		$this->db->join('users b', 'b.id_user = a.id_user');
	...
	public function getSetujuiPengadaan()
	{
		$this->db->select('*');
		$this->db->from('pengadaan a');
		$this->db->join('users b', 'b.id_user = a.id_user');
	...
	public function filterSetujuiPengadaan($id_lokasi, $tahun_pengadaan)
	{
		$this->db->select('*');
		$this->db->from('pengadaan a');
		$this->db->join('users b', 'b.id_user = a.id_user');
